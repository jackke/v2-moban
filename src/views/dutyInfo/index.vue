<template>
  <div class="duty-info">
      <div class="title" style="height: 50px">
          {{ moment(dateDay).format('YYYY-MM-DD') }} 值班人员表   
          <el-button type="text" size="medium" v-if="!tableStatus" @click="displayStatus = !displayStatus">{{ displayStatus ? '隐藏日期' :'展开日期'}} </el-button>
      </div>
      <div class="flex">
